// Laboratório Digital de Arquitetura - Script Principal
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    navLinks.forEach(link => {
        link.addEventListener('click', () => {
            ...
            // Carrega a API apenas quando entrar na aba específica
    ...
    // --- TABELA VERDADE (Ajuste da Expressão no Cabeçalho) ---
    ...
    // --- CURIOSIDADES MATH (Layout 3 Colunas & Fundo Bege) ---
    async function carregarApi() {
        ...
        try {
            ...
            // Criamos o card principal para evitar duplicação de bordas
